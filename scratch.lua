...
--[[
local fireArmor = table.deepcopy(data.raw["assembling"]["oil-refinery"]) -- copy the table that defines the heavy armor item into the fireArmor variable

fireArmor.name = "air-liquifier"
fireArmor.icons = {
  {
    icon = fireArmor.icon,
...
local airLiquifier = {
    ...
    mining_speed = 0.5,
    resource_categories = {"condensing"},
...
local recipe = {
    ...
    normal = {
        ...
        result = "air-liquifier",
    },
}
data:extend{airLiquifier,recipe}
...
data:extend(
{
    ...
    minable = {mining_time = 0.1, result = "air-liquifier"},
    max_health = 150,
  ...
  order = "b[fluids]-a[air-liquifier]",
  place_result = "air-liquifier",
  stack_size = 20
  },
...
table.deepcopy(data.raw["recipe"]["modular-armor"])
recipe.enabled = true
recipe.name = "air-liquifier"
recipe.ingredients = {{"copper-plate",200},{"steel-plate",50}}
recipe.result = "air-liquifier"
]]
